<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            ...
            @if(CustomHelper::userHasPermission(Auth::user(),['dashboard_view']))
            ...
            @if(CustomHelper::userHasPermission(Auth::user(),['student_view']))
            ...
            @if(CustomHelper::userHasPermission(Auth::user(),['class_view']))
            ...
            @if(CustomHelper::userHasPermission(Auth::user(),['marketing_view']))
            ...
            @if(CustomHelper::userHasPermission(Auth::user(),['user_view']))
            ...
            @if(CustomHelper::userHasPermission(Auth::user(),['finance_view']))
            ...
            @if(CustomHelper::userHasPermission(Auth::user(),['advance_search_view']))
                <li>
                    <a href="javascript:;">
                        <i class="icon-settings"></i>
