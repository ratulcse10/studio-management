        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    {{Form::model($revenue,['route' => ['revenue.update',$revenue->id], 'class' => 'form-horizontal', 'method' => 'put' ])}}

                     <div class="form-group">
                        {{ Form::label('revenue', 'Revenue*', array('class' => 'col-md-2 control-label')) }}
                        <div class="col-md-4">
                            {{ Form::text('revenue', null, array('class' => 'form-control', 'placeholder' => 'Revenue')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {{ Form::select('month', $month, null, array('class' => 'form-control', 'id' => 'month')) }}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            {{ Form::submit('Edit Revenue', array('class' => 'btn btn-primary')) }}
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
